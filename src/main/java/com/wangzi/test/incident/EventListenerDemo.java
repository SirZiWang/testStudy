...
public class EventListenerDemo implements EventListener{
	...
	//事件发生后的回调方法  
	public void fireEvent(EventDemo event){
		EventSoureceDemo  eventSourece = (EventSoureceDemo) event.getSource();  
		System.out.println("My name has been changed!");  
		System.out.println("I got a new name,named \"" + eventSourece.getName() + "\"");
	}
}
