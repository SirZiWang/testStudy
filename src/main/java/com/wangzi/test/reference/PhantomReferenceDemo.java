...
public class PhantomReferenceDemo {
	...
	public static void test0(){
		...
		PhantomReference<String> pReference = new PhantomReference<>(new String("T"), refQueue);
		System.out.println(pReference.get()); // null
		// 只有被垃圾回收后才把referent放进ReferenceQueue中
		System.out.println(refQueue.poll() == pReference); // false
		System.gc();
		System.runFinalization();
		System.out.println(refQueue.poll() == pReference); // true
	}
